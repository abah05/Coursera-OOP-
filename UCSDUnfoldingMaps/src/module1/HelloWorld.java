...
public class HelloWorld extends PApplet
{
	...
	public void setup() {
		...
		AbstractMapProvider provider1 = new Google.GoogleSimplifiedProvider();
		// Set a zoom level
		int zoomLevel = 10;
		...
		map2 = new UnfoldingMap(this, 420, 50, 350, 500, provider1);
		
		map2.zoomAndPanTo(zoomLevel, new Location(40.6f,-73.9f));
